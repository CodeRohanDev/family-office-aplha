          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-charcoal/20 focus:outline-none focus:border-gold transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-charcoal/20 focus:outline-none focus:border-gold transition-colors resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-gold text-navy px-8 py-4 rounded-xl font-semibold hover:bg-navy hover:text-white transition-all duration-300 flex items-center justify-center"
                >
                  Send Message
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-charcoal text-sm">Monday - Friday, 9 AM - 6 PM EST</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-charcoal">Monday - Friday: 9:00 AM - 6:00 PM EST</p>
                      <p className="text-charcoal">Emergency Support: 24/7</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-8">
                ...
                <div className="bg-offWhite rounded-lg h-64 flex items-center justify-center">
                  <div className="text-center">
      ...
      <section className="py-20 bg-navy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            className="bg-gold text-navy px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-navy transition-all duration-300 inline-flex items-center"
          >
