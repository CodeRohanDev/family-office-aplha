    ...
    <section className="py-24 bg-offWhite">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="font-playfair text-3xl font-bold text-navy mb-6">
                Our Story
              </h3>
                ...
                {values.map((value, index) => (
                  <div key={value.title} className="flex items-start space-x-4">
                    <div className="bg-gold/10 p-2 rounded-lg flex-shrink-0">
                      <value.icon className="text-gold" size={20} />
                    </div>
                    <div>
              ...
              <Link
                ...
                className="bg-navy text-white px-8 py-4 rounded-xl font-semibold hover:bg-gold hover:text-navy transition-all duration-300 inline-flex items-center group"
              >
                Our Full Story
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-r from-navy to-charcoal rounded-2xl p-12 text-center"
        >
          <div className="max-w-4xl mx-auto">
            ...
            <blockquote className="text-2xl md:text-3xl font-playfair text-white mb-6 leading-relaxed">
